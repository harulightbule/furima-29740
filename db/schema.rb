...
ActiveRecord::Schema.define(version: 2020_09_23_052321) do
  ...
  create_table "addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.bigint "item_user_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["item_user_id"], name: "index_addresses_on_item_user_id"
  end
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "reading_last", null: false
    t.string "reading_first", null: false
  ...
  add_foreign_key "addresses", "item_users"
